import 'package:btl/common/widgets/images/t_circular_image.dart';
import 'package:btl/common/widgets/products/product_cards/product_card_vertical.dart';
import 'package:btl/common/widgets/shimmers/category_shimmer.dart';
import 'package:btl/common/widgets/shimmers/search_category_shimmer.dart';
...
import 'package:btl/features/shop/screens/all_products/all_products.dart';
import 'package:btl/features/shop/screens/brand/brand.dart';
                  ...
                  .map((brand) => GestureDetector(
                        ...
                        child: Padding(
                          ...
                          child: TVerticalImageAndText(
                            ...
                            title: brand.name,
                            isNetworkImage: true,
                            textColor: HelperFunctions.isDarkMode(context) ? MyColors.white : MyColors.dark,
                  ...
                  child: Row(
                    children: [
                      TCircularImage(
                        ...
                        padding: 0,
                        isNetworkImage: true,
                        overlayColor: isDark ? MyColors.white : MyColors.dark,
