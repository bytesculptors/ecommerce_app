          ...
          children: attribute.values!.map((value) {
            ...
            return Theme(
              ...
              child: ChoiceChip(
                ...
                labelStyle: TextStyle(color: isSelected ? Colors.white : (isAvailable ? isDark ? MyColors.white : MyColors.dark : isDark ? Colors.white30 :Colors.grey)),
                elevation: isSelected ? 5.0 : 0.0,
                backgroundColor: isSelected ? MyColors.primary : (isAvailable ? Colors.transparent : isDark ? MyColors.dark : Colors.grey.shade200),
