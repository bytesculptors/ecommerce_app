import 'package:btl/data/repositories/product/product_repository.dart';
...
class SubCategoriesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: MyAppBar(showBackArrow: true, title: Text(category.name)),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              /// Banner
              const TRoundedImage(width: double.infinity, imageUrl: Images.promoBanner3, applyImageRadius: true),
