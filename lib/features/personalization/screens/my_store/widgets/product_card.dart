...
import 'package:btl/features/shop/screens/product_detail/product_detail.dart';
...
class MyStoreProductCard extends StatelessWidget {
  const MyStoreProductCard({super.key, required this.product, this.isNetworkImage = true});
