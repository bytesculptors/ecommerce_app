...
import '../../controllers/start_selling_controller.dart';

class StartSellingScreen extends StatefulWidget {
  StartSellingScreen({Key? key}) : super(key: key);

  @override
  _StartSellingScreenState createState() => _StartSellingScreenState();
}
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Form(
            key: controller.startSellingFormKey,
            child: Column(
              ...
              children: [
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                      prefixIcon: Icon(Iconsax.shop), labelText: 'Store Name'),
                ),
                const SizedBox(height: Sizes.spaceBtwInputFields),
                TextFormField(
                  controller: controller.ownerName,
                  validator: (value) =>
                      Validator.validateEmptyText('Owner Name', value),
                  decoration: const InputDecoration(
                      prefixIcon: Icon(Iconsax.user), labelText: 'Owner Name'),
                ),
                const SizedBox(height: Sizes.spaceBtwInputFields),
                TextFormField(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                      onPressed: () => controller.startSelling(),
