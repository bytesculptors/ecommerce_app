...
class UploadDataScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const MyAppBar(title: Text('Upload Data'), showBackArrow: true),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    leading: const Icon(Iconsax.category, size: 28, color: MyColors.primary),
                    title: Text('Upload Categories', style: Theme.of(context).textTheme.titleMedium),
                    trailing: IconButton(
                      onPressed: () => controller.uploadCategories(),
                      icon: const Icon(Iconsax.arrow_up_1, size: 28, color: MyColors.primary),
                    ),
                  ),
                  const SizedBox(height: Sizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.shop, size: 28, color: MyColors.primary),
                  ...
                  const SizedBox(height: Sizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.shopping_cart, size: 28, color: MyColors.primary),
                  ...
                  const SizedBox(height: Sizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.image, size: 28, color: MyColors.primary),
                  ...
                  const SizedBox(height: Sizes.spaceBtwItems),
                  ListTile(
                    leading: const Icon(Iconsax.link, size: 28, color: MyColors.primary),
