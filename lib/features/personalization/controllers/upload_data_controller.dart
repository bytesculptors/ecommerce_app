...
import 'package:btl/features/shop/controllers/product/banner_controller.dart';
...
class UploadDataController extends GetxController {
  ...
  Future<void> uploadCategories() async {
    try {
      ...
      TFullScreenLoader.openLoadingDialog('Sit Tight! Your CATEGORIES are uploading...', Images.cloudUploadingAnimation);
  ...
  Future<void> uploadProductCategories() async {
    try {
      ...
      TFullScreenLoader.openLoadingDialog(
        ...
        Images.cloudUploadingAnimation,
      );
  ...
  Future<void> uploadBrands() async {
    try {
      ...
      TFullScreenLoader.openLoadingDialog('Sit Tight! Your BRANDS are uploading...', Images.cloudUploadingAnimation);
  ...
  Future<void> uploadBanners() async {
    try {
      ...
      TFullScreenLoader.openLoadingDialog('Sit Tight! Your Banners are uploading. It may take a while...', Images.cloudUploadingAnimation);
